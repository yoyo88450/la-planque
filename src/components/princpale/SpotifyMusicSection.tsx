    ...
    const loadTracks = async () => {
      try {
        ...
        if (tracksResponse.status === 401) {
          console.log('Access token expired, attempting to get new token...');
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Spotify Player - Positioned behind the card */}
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                          <div className="transform -translate-y-2 scale-90 opacity-80">
                            <SpotifyPlayer
                              trackId={track.id}
                              accessToken={spotifySettings.accessToken}
                              onTrackEnd={() => setCurrentlyPlaying(null)}
                            />
                          </div>
                        </div>
